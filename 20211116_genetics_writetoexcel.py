...
# Input files
filedir = 'Q:\\Projects\\MicrobLiver\\Results\\Genetics\\SNPs_PRSs_for_datahub\\preprocessing\\split\\'

# this is the list of input files (all csv)
filenames = glob.glob(os.path.join(filedir, '*.csv'))

# this is the metadata
metadata = 'Q:\\Projects\\MicrobLiver\\Results\\Genetics\\SNPs_PRSs_for_datahub\\preprocessing\\metadata\\metadata.xlsx'

# Output dir
outputdir = 'Q:\\Projects\\MicrobLiver\\Results\\Genetics\\SNPs_PRSs_for_datahub\\'
